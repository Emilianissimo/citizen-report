    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Добавление врача на сайт</h3>
        </div>
        {{Form::open([
          'route' => 'doctors.store',
          'files' => true
            ...
            <div class="row" style="padding: 20px;">
              ...
              <div class="col-md-6">
                  ...
                  <div class="form-group" style="border: 1px solid red; padding: 10px">
                    <label for="image" required style="width: 100%">Фото <br> <div style="background-image: url('/img/no-image.png')" class="video-image"></div></label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="experience_ru" placeholder="" value="{{old('experience_ru')}}" name="experience_ru">
                  </div>
                  <div class="form-group">
                    <label for="experience_uz">Опыт Уз</label>
                    <input type="text" class="form-control" id="experience_uz" placeholder="" value="{{old('experience_uz')}}" name="experience_uz">
                  </div>        
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="education_ru" placeholder="" value="{{old('education_ru')}}" name="education_ru">
                  </div>
                  <div class="form-group">
                    <label for="experience_uz">Образование Уз</label>
                    <input type="text" class="form-control" id="education_uz" placeholder="" value="{{old('education_uz')}}" name="education_uz">
                  </div>     
              </div>
              <div class="col-md-6">
                <div class="form-group">
