...
@section('title', 'Изменение прихода')
...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Изменить донат</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Главная</a></li>
          <li class="breadcrumb-item active"><a href="{{route('finances.consumptions')}}">Приход</a></li>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Изменение прихода на сайте</h3>
        </div>
        {{Form::open([
          'route' => ['finances.incomeUpdate', $income->id],
          'files' => 'true',
          'method'=>'put' 
          ])}}
          @include('admin.errors')
            ...
            <div class="row" style="padding: 20px;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea id="from" name="from" required cols="30" rows="10" class="form-control">{{$income->from}}</textarea>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea id="text" name="text" required cols="30" rows="10" class="form-control">{{$income->text}}</textarea>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="amount" placeholder="" value="{{ (int) $income->amount}}" name="amount">
                </div>
              </div>

              <div class="col-md-12">
                <div class="form-group" style="border: 1px solid red; padding: 10px">
                  <label for="image" style="width: 100%;object-fit: cover;object-position: center center;">Картинка<br> <div style="background-image: url('{{$income->getFile()}}')" class="video-image"></div></label>
                  <input type="file" id="image" name="image">

                  <p class="help-block">Картинка в формате JPG</p>
                </div>              
              </div>
              @if($income->getFile() !== '/img/no-image.png')
              <div class="col-md-12 row" style="position: relative;">
                  <div  class="col-md-4 mt-2">
                    <img class="w-100" style="height:17rem;object-fit: cover;object-position: center center;" src="{{$income->getFile()}}" alt="">
                    <div class="trash-icon" style="position: absolute;top: 5px;right: 10px;">
                      <a href="{{route('finances.incomeImageDestroy', $income->id)}}"><i style="font-size: 25px;color:red;" class="fa fa-trash"></i></a>
                    </div>
                  </div>
              </div>
              @endif
