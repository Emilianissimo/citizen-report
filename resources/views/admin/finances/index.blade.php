        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              @elseif(Auth::user()->is_org_admin)
              <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Главная</a></li>
              <li class="breadcrumb-item active">Донаты</li>
              @endif
            </ol>
          </div>
        </div>
            ...
            <div class="card-body">
              @if(Auth::user()->is_org_admin == 1)
                ...
                <div class="form-group mt-5" style="text-align: right">
                  <a href="{{route('finances.incomeCreate')}}" class="btn btn-success">Добавить</a>
                </div>
                ...
                <div class="card-body">
                  <table id="example3" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      @foreach($organizationIncomes as $income)
                      <tr>
                        <td>{!! $income->from !!}</td>
                        <td>{!! $income->text !!}</td>
                        <td>{{$income->amount}}</td>
                        ...
                        <td id="actions" style="padding: 10px;">
                          <a style="font-size: 25px" href="{{route('finances.incomeEdit', $income->id)}}" class="fa fa-eye"></a>
                        </td>
                        <td><a href="{{route('finances.incomeDestroy', $income->id)}}"><i style="font-size: 25px;color:red;" class="fa fa-trash"></i></a></td>
                        </tr>
                      @endforeach
                    </tbody>
                  </table>
                  {{$organizationIncomes->links()}}
                </div>
