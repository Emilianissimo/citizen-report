            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-4 p-5" style="box-shadow: 5px 5px 5px gray; border-radius: 20px">
                    ...
                    @if(Auth::user()->is_admin || Auth::user()->id == $socialRequest->manager_id || ($socialRequest->manager && Auth::user()->is_org_admin && Auth::user()->organization_id == $socialRequest->manager->organization_id))
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        @if(Auth::user()->is_admin || Auth::user()->id == $socialRequest->manager_id || (Auth::user()->is_org_admin && Auth::user()->organization_id == isset($socialRequest->manager->organization_id)))
