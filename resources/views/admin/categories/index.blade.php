                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td id="actions" style="padding: 10px;">
                      <a style="font-size: 25px" href="{{route('categories.edit', $category->id)}}" class="fa fa-edit"></a>
                      <button  data-route="{{route('categories.destroy', $category->id)}}" type="button" class="delete">
