    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Добавление категории услуг на сайт</h3>
        </div>
        {{Form::open([
          'route' => 'service-categories.store',
          'files' => true
          ])}}
            ...
            <div class="row" style="padding: 20px;">
              <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="sup_title_ru" placeholder="" value="{{old('sup_title_ru')}}" name="sup_title_ru">
                  </div>
                  <div class="form-group">
                    <label for="sup_title_uz">Тип Категории Уз</label>
                    <input type="text" class="form-control" id="sup_title_uz" placeholder="" value="{{old('sup_title_uz')}}" name="sup_title_uz">
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
