            ...
            <div class="col-lg-8 col-xl-8">
                <div class="card-box">
                    <ul class="nav nav-pills navtab-bg">
                        ...
                        <li class="nav-item">
                            <a href="{{route('client.organization.getConsumptions', [app()->getLocale(),$organization->id])}}"class="nav-link  ml-0 active">
                    ...
                    <div class="tab-content">
                        ...
                        <!-- end timeline content-->
                            ...
                            <div class="tab-pane  show active" id="consumptions">
